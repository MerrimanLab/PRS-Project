...
forest(tophi, 
       ...
       leftcols = c("studlab", "N case", "N control"),
       rightcols = c("effect", "ci"),
       leftlabs = c("Effect of rs2231142 on Tophi", "N case", "N control"),
       rightlabs = c("OR", "[95% CI]"),
       addrows.below.overall = 2, 
       comb.random = F,
       overall = F)
...
forest(tophi_adj, 
       ...
       leftcols = c("studlab", "N case", "N control"),
       rightcols = c("effect", "ci"),
       leftlabs = c("Effect of rs2231142 on Tophi (Duration Adjusted)", "N case", "N control"),
       rightlabs = c("OR", "[95% CI]"),
       addrows.below.overall = 2, 
       comb.random = F,
       overall = F)
...
forest(tophi, 
       ...
       leftcols = c("studlab", "N case", "N control"),
       rightcols = c("effect", "ci"),
       leftlabs = c("Effect of rs10011796 on Tophi", "N case", "N control"),
       rightlabs = c("OR", "[95% CI]"),
       addrows.below.overall = 2, 
       comb.random = F,
       overall = F)
...
forest(tophi_adj, 
       ...
       leftcols = c("studlab", "N case", "N control"),
       rightcols = c("effect", "ci"),
       leftlabs = c("Effect of rs10011796 on Tophi (Duration Adjusted)", "N case", "N control"),
       rightlabs = c("OR", "[95% CI]"),
       addrows.below.overall = 2, 
       comb.random = F,
       overall = F)
